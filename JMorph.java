...
/*************
 * The driver class for JMorph, a simple image morphing program that allows users to upload two images and morph one into another.
 * Additionally, JMorph allows users to update speed and the intensity of each image.
 *************/
...
public class JMorph extends JFrame implements ActionListener, ChangeListener {
    ...
    private JButton reset, run, preview, apply, groupButton;
    ...
    public JMorph() {
        ...
        title = new JPanel();
        JLabel header = new JLabel("Java Image Morpher 5000");
        header.setFont(new Font("Helvetica Neue", Font.PLAIN, 30));
        ...
        groupButton = new JButton("Group Select Mode");
        ...
        controls.add(preview, constraints);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getActionCommand().equals("preview")){
            animate = new JPreview(prePanel, postPanel, row, col, seconds);
        }
